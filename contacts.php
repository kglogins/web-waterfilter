...
if (isset($_POST["submit"]))
{
	...
	$email_from = 'kontaktu_forma';
	$to = 'info@waterfilter.lv';
	$subject = "Jauns ziņojums no klienta $name mājaslapā";
	$email_body = "Jūs esat saņēmis jauno ziņojumu no klienta $name.\n".
    "Klienta e-pasts: $visitor_email \n".
	"Klienta ziņa: $message \n\n";
	...
	if(!$_POST['message']){
		$messageErr = 'Ievadiet ziņu.';
	};
	
	if (!$nameErr && !$emailErr && !$messageErr) {
		if (mail ($to, $subject, $email_body, $headers)) {
			$result='<div class="alert alert-success" role="alert"><b>Paldies</b>, ka sazinājāties ar mums! Speciālists tuvākajā laikā sazināsies ar jums.</div>';
		}else{
			$result='Nesanāca!';
		}
...
<title>Waterfilter | Ūdens filtri | Serviss</title>
...
<section style="margin-bottom: 30px">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h1>Kontakti</h1>
		<p style="padding-top: 20px; font-size: 18px; padding-bottom: 10px">Tālrunis: &nbsp;+371 22002248</p>
        <p>E-pasts: &nbsp;info@waterfilter.lv</p>
        <p>Faktiskā adrese: &nbsp;Elijas iela 11-6, LV-1050</p>
		<br>
	  </div>
	  <div class="col-xs-12">
		<h2 id="form">Sazinies ar speciālistu</h2>
      <form method="post" name="myemailform" action="contacts.php">
    ...
    <div class="form-group">
    	...
    	<input type="text" class="form-control" name="message" placeholder="Ziņa">
    	<div class="error"><?php echo $messageErr;?></div>
    </div>
    </div>
    <div class="col-xs-12 col-lg-2 col-md-3">
    <button type="submit" name="submit" value="submit" class="btn btn-default" style="margin-bottom: 10px">Sūtīt ziņu</button>
	</div>
    <div class="col-xs-12 col-lg-10 col-md-9"><?php echo $result;?></div>
	</form>
    </div>
  </div>
</section>
